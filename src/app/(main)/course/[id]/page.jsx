...
async function getCourse(id) { const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/course.json`, {
  cache: "no-store",
});
...
<div className="grid grid-cols-2 gap-4 text-sm mb-6">
 ...
 <div className="flex items-center justify-between"><EnrollModal />
